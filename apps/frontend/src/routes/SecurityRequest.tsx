    ...
    return (
        <div className="centerContent flex flex-col">
            <div className={submittedWindowVisibility.formScreen}>
                ...
                <p className="text-light-white pb-8 text-center">Fill out the form below to make a security request.</p>
                ...
                <form ref={formRef} onSubmit={e => {
                    ...
                    <div className="formTest w-full my-10 grid grid-cols-2 gap-12">
                            ...
                            <div>
                                <p className={"dark:text-white text-left font-bold w-full"}>Quantity of Personnel</p>
                                <input
