                    ...
                    <div className="w-56">
                        <div className="border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                <p className="text-deep-blue font-bold text-lg underline cursor-pointer"
                                    onClick={() => openInNewTab("https://www.jetbrains.com/webstorm/")}>Webstorm</p>
                                <p className="text-deep-blu cursor-default">2023.3</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">4.29.0</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">3.12</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">16.13.3</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">6.7.1</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">React 18</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">5.4.5</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">1.6.8</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">4.3.1</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56 pb-10">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">16.2</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56 pb-10">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">5</p>
                                <br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-56 pb-10">
                        <div className=" border-2 rounded-3xl bg-gradient-to-t from-white to-blue-300 flex flex-col centerContent">
                            ...
                            <div className="w-fit pt-2">
                                ...
                                <p className=" text-deep-blue cursor-default">v3.0</p>
                                <br/>
                            </div>
                        </div>
                    </div>
