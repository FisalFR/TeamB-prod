                    ...
                    <form ref={formRef} onSubmit={e => {
                        ...
                        <div className="formTest w-full my-10 grid grid-cols-2 gap-12 ">
                            <div className="flex flex-col w-fit">
                                ...
                                <input type="text" required
                                       ...
                                       placeholder={"Name"}
                                       className={"dark:text-white dark:bg-black border-solid border-deep-blue border-2 rounded overflow-hidden flex items-start p-[5px] w-full"}/>
                                <br/>
                            ...
                            <div className="flex flex-col w-fit">
                                ...
                                <p className={"dark:text-light-white text-left font-bold "}>What is the priority of this request?</p>
                        ...
                        <div className="">
                            <textarea id={"feedback"}
                                      className={"dark:text-light-white dark:bg-black w-full max-w-full h-28 max-h-28 p-1 border-deep-blue border-solid border-2 rounded"}
