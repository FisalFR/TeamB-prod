                ...
                <div className=' w-full pl-31 flex flex-col'>
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <p onClick={HandleLogin}
                           className="dark:text-white hover:animate-none text-xl hover:cursor-pointer hover:text-deep-blue hover:font-bold pb-5">
                            Click here to navigate!</p>


                    </div>
                    <div
                        className="dark:bg-black max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl my-4 md:flex">
                        ...
                        <div className="dark:bg-black p-8 md:w-1/2 md:order-2">
                            <h4 className="dark:text-white block mt-4 text-lg leading-tight font-medium text-black">New
                                Feature:</h4>
                            <h4 className="dark:text-white text-lg leading-tight font-medium text-black">Security
                                Services</h4>
